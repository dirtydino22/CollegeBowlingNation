...
var ctrls = {
    user: require('../api/user/user.controller'),
    tempUser: require('../api/tempuser/tempuser.controller'),
    news: require('../api/news/news.controller'),
    blog: require('../api/blog/blog.controller')
};
...
function onConnect(socket) {
  ...
  require('../api/tempuser/tempuser.socket').register(socket);
